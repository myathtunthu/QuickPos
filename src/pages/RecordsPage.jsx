...
// ─── Print Voucher (same as before) ───
const doPrint = (record, settings) => {
  // ... (function unchanged, included in full code below)
};
...
export default function RecordsPage() {
  ...
  // ရက်စွဲ filter – default အနေဖြင့် ဒီနေ့မှ ဒီနေ့အထိ ပြမည်
  ...
  // Helper to extract ISO date string from record
  ...
  // Apply type filter, date range, and search term
  ...
  // Report summary (from date range only, ignoring type filter)
  const reportStats = useMemo(() => {
    ...
    // Net profit (simple: sales - purchases - expenses)
